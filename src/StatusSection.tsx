  ...
  return (
    <DescriptionSection
      icon={
        ...
        >
          <title>62 all</title>
          <path d="M86.39,40.37h-11a3,3,0,0,0-2.87,2.13L66.27,63.06a2,2,0,0,1-3.87-.18l-5.58-27A7.84,7.84,0,0,0,49,29.52h0a7.84,7.84,0,0,0-7.82,6.33l-3.64,17a2,2,0,0,1-3.84.25L29,39.86a3,3,0,0,0-2.83-2H13.61a3,3,0,0,0,0,6H24l4,11.27a8,8,0,0,0,15.36-1L47,37.1a1.88,1.88,0,0,1,2-1.58h0a1.89,1.89,0,0,1,2,1.59l5.58,27A7.9,7.9,0,0,0,64,70.47h.39A7.89,7.89,0,0,0,72,64.8l5.6-18.44h8.77a3,3,0,0,0,0-6Z"></path>
        </svg>
      }
    >
