  ...
  return (
    <header className="text-gray-600 body-font border-b border-gray-100 bg-gray-50">
      <div className="container mx-auto flex flex-wrap p-5 flex-row md:flex-row items-center justify-between">
        <Link href="/">
          <a className="flex title-font font-medium items-center mb-4 md:mb-0 colorful">
        ...
        <Link href="/">
          <a className="inline-flex items-center bg-blue-100 border py-1 px-3 focus:outline-none hover:bg-blue-200 border-transparent hover:border-blue-400 rounded text-base mt-4 md:mt-0 transition-colors duration-200 ease-in-out">
            Home
            <svg
              fill="none"
              stroke="currentColor"
